...
def mnist_dataloader(hparams):
    ...
    train_dataset = datasets.MNIST(root='./mnist_vae/data', train=True, download=True, transform=transform)
    test_dataset = datasets.MNIST(root='./mnist_vae/data', train=False, download=True, transform=transform)
